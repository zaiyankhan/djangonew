...
def delete_ticket(request, ticket_id):
    ticket = get_object_or_404(Ticket, id=ticket_id, submitter_email=request.user.email)
...
def ticket_list(request):
    ...
    base_tickets = Ticket.objects.filter(queue__in=user_queues, submitter_email=request.user.email)
